...
public class ServicesHeaderController extends StringController {
    ...
    @PostMapping
    public String updateServicesHeader(WordCardsContent cardsContent,
                                       @RequestParam(name = "lang", required = false) String lang) throws JsonProcessingException {
        return super.updateSection(cardsContent, "no_action_param_provided", WordCard::new, "services-page", lang);
    }
